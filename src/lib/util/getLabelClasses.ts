...
export const getLabelClasses = (color: string) =>
  match(color)
    ...
    .with("emerald", () => ({
      ...
      text: "text-emerald-700 dark:text-emerald-600",
    ...
    .with("sky", () => ({
      ...
      text: "text-sky-700 dark:text-sky-600",
      icon: "text-sky-500",
    }))
    .with("blue", () => ({
    ...
    .with("indigo", () => ({
      ...
      text: "text-indigo-700 dark:text-indigo-600",
      icon: "text-indigo-500",
    }))
    .with("violet", () => ({
      bg: "bg-violet-50 dark:bg-violet-900/20",
      text: "text-violet-700 dark:text-violet-600",
    ...
    .with("fuchsia", () => ({
      ...
      text: "text-fuchsia-700 dark:text-fuchsia-600",
      icon: "text-fuchsia-500",
    }))
    .with("pink", () => ({
      bg: "bg-pink-50 dark:bg-pink-900/20",
      text: "text-pink-700 dark:text-pink-600",
      icon: "text-pink-500",
    }))
    .with("rose", () => ({
      bg: "bg-rose-50 dark:bg-rose-900/20",
      text: "text-rose-700 dark:text-rose-600",
      icon: "text-rose-500",
    }))
    .otherwise(() => ({
      bg: "bg-base-50 dark:bg-base-900/20",
      text: "text-base-700 dark:text-base-600",
      icon: "text-base-500",
    }));
