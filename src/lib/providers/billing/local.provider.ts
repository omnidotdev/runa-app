...
const UNLIMITED_ENTITLEMENTS: EntitlementsResponse = {
  ...
  entitlements: [
    createEntitlement("tier", "enterprise", "runa"),
    createEntitlement("max_workspaces", "unlimited", "runa"),
    createEntitlement("max_members", "unlimited", "runa"),
    createEntitlement("sso_enabled", "true", "runa"),
    createEntitlement("audit_logs", "true", "runa"),
  ],
};
