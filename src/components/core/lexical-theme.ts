...
const theme: EditorThemeClasses = {
  ...
  list: {
    ...
    listitemChecked:
      "relative list-none pl-6 line-through text-base-500 dark:text-base-400 before:absolute before:top-1/2 before:left-0 before:-translate-y-1/2 before:h-4 before:w-4 before:cursor-pointer before:rounded-sm before:border before:border-primary-500 before:bg-primary-500 before:text-center before:text-xs before:leading-4 before:text-white before:content-['✓']",
    listitemUnchecked:
      "relative list-none pl-6 before:absolute before:top-1/2 before:left-0 before:-translate-y-1/2 before:h-4 before:w-4 before:cursor-pointer before:rounded-sm before:border before:border-base-400 dark:before:border-base-500 before:content-['']",
  },
