...
const popoverVariants = tv({
  slots: {
    trigger:
      "inline-flex transition-transform [&[data-state=open]>svg]:rotate-90 items-center justify-center outline-hidden focus-visible:border-ring focus-visible:ring-ring focus-visible:ring-[1px]",
    content:
