...
const popoverVariants = tv({
  slots: {
    trigger:
      "inline-flex transition-transform [&[data-state=open]>svg]:rotate-90 items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
    content:
