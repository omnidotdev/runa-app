...
const popoverVariants = tv({
  slots: {
    trigger:
      "inline-flex transition-transform [&[data-state=open]>svg]:rotate-90 items-center justify-center outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] outline-hidden",
    content:
