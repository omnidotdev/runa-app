        ...
        return (
          ...
          >
            <button
              ...
              className="w-full flex items-center gap-2 text-left px-4 py-3 rounded-t-lg border-b border-gray-200 dark:border-gray-700"
            >
  ...
  return (
    ...
    >
      <div className="flex gap-2 flex-1 min-w-0">
        ...
        <PriorityIcon className={`w-3 h-3 ${priorityConfig[task.priority].className} flex-shrink-0 mt-1`} />
