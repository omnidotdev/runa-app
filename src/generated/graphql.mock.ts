 ...
 * )
 */
export const mockCreateSettingMutation = (resolver: GraphQLResponseResolver<Types.CreateSettingMutation, Types.CreateSettingMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.CreateSettingMutation, Types.CreateSettingMutationVariables>(
    'CreateSetting',
    resolver,
    options
  )
 ...
 * )
 */
export const mockProjectTaskIndexQuery = (resolver: GraphQLResponseResolver<Types.ProjectTaskIndexQuery, Types.ProjectTaskIndexQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.ProjectTaskIndexQuery, Types.ProjectTaskIndexQueryVariables>(
    'ProjectTaskIndex',
    resolver,
    options
  )
