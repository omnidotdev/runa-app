 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockCreateNotificationPreferenceMutation(
 *   ({ query, variables }) => {
 *     const { input } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockCreateNotificationPreferenceMutation = (resolver: GraphQLResponseResolver<Types.CreateNotificationPreferenceMutation, Types.CreateNotificationPreferenceMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.CreateNotificationPreferenceMutation, Types.CreateNotificationPreferenceMutationVariables>(
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockUpdateNotificationPreferenceMutation(
 *   ({ query, variables }) => {
 *     const { rowId, patch } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockUpdateNotificationPreferenceMutation = (resolver: GraphQLResponseResolver<Types.UpdateNotificationPreferenceMutation, Types.UpdateNotificationPreferenceMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.UpdateNotificationPreferenceMutation, Types.UpdateNotificationPreferenceMutationVariables>(
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockUpdateProjectLinkMutation(
 *   ({ query, variables }) => {
 *     const { rowId, patch } = variables;
 *     return HttpResponse.json({
 *       data: { updateProjectLink }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockUpdateProjectLinkMutation = (resolver: GraphQLResponseResolver<Types.UpdateProjectLinkMutation, Types.UpdateProjectLinkMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.UpdateProjectLinkMutation, Types.UpdateProjectLinkMutationVariables>(
    'UpdateProjectLink',
    resolver,
    options
  )
 ...
 * )
 */
export const mockUpdateSettingMutation = (resolver: GraphQLResponseResolver<Types.UpdateSettingMutation, Types.UpdateSettingMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.UpdateSettingMutation, Types.UpdateSettingMutationVariables>(
    'UpdateSetting',
    resolver,
    options
  )
 ...
 * )
 */
export const mockMoveTaskMutation = (resolver: GraphQLResponseResolver<Types.MoveTaskMutation, Types.MoveTaskMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.MoveTaskMutation, Types.MoveTaskMutationVariables>(
    'MoveTask',
    resolver,
    options
  )
 ...
 * )
 */
export const mockTaskAttachmentsQuery = (resolver: GraphQLResponseResolver<Types.TaskAttachmentsQuery, Types.TaskAttachmentsQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.TaskAttachmentsQuery, Types.TaskAttachmentsQueryVariables>(
    'TaskAttachments',
    resolver,
    options
  )
 ...
 * )
 */
export const mockWorkspaceLabelsQuery = (resolver: GraphQLResponseResolver<Types.WorkspaceLabelsQuery, Types.WorkspaceLabelsQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.WorkspaceLabelsQuery, Types.WorkspaceLabelsQueryVariables>(
    'WorkspaceLabels',
    resolver,
    options
  )
 ...
 * )
 */
export const mockLinkPreviewQuery = (resolver: GraphQLResponseResolver<Types.LinkPreviewQuery, Types.LinkPreviewQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.LinkPreviewQuery, Types.LinkPreviewQueryVariables>(
    'LinkPreview',
    resolver,
    options
  )
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockNotificationPreferenceQuery(
 *   ({ query, variables }) => {
 *     const { userId } = variables;
 *     return HttpResponse.json({
 *       data: { notificationPreferenceByUserId }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockNotificationPreferenceQuery = (resolver: GraphQLResponseResolver<Types.NotificationPreferenceQuery, Types.NotificationPreferenceQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.NotificationPreferenceQuery, Types.NotificationPreferenceQueryVariables>(
 ...
 *   ({ query, variables }) => {
 *     const { organizationId, search } = variables;
 *     return HttpResponse.json({
 *       data: { projectColumns }
 *     })
 *   },
 ...
 * mockProjectsQuery(
 *   ({ query, variables }) => {
 *     const { organizationId, search, userId } = variables;
 *     return HttpResponse.json({
 *       data: { projects }
 *     })
 *   },
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockSettingByOrganizationIdQuery(
 *   ({ query, variables }) => {
 *     const { organizationId } = variables;
 *     return HttpResponse.json({
 *       data: { settingByOrganizationId }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockSettingByOrganizationIdQuery = (resolver: GraphQLResponseResolver<Types.SettingByOrganizationIdQuery, Types.SettingByOrganizationIdQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.SettingByOrganizationIdQuery, Types.SettingByOrganizationIdQueryVariables>(
 ...
 *     return HttpResponse.json({
 *       data: { taskByProjectIdAndNumber }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockTaskByNumberQuery = (resolver: GraphQLResponseResolver<Types.TaskByNumberQuery, Types.TaskByNumberQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.TaskByNumberQuery, Types.TaskByNumberQueryVariables>(
    'TaskByNumber',
    resolver,
    options
  )
