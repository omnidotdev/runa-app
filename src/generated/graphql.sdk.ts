...
export type ProjectBySlugQuery = { __typename?: 'Query', projectBySlugAndOrganizationId?: { __typename?: 'Project', rowId: string, name: string, isPublic: boolean, color?: string | null, description?: string | null, prefix?: string | null } | null };
...
export const UpdateLabelDocument = gql`
  ...
  updateLabel(input: {rowId: $rowId, patch: $patch}) {
    ...
    `;
export const CreateNotificationPreferenceDocument = gql`
...
export const LabelsDocument = gql`
  ...
  labels(condition: {projectId: $projectId}, orderBy: NAME_ASC) {
    ...
    ${LabelFragmentDoc}`;
export const WorkspaceLabelsDocument = gql`
...
export const TaskDocument = gql`
  ...
  task(rowId: $rowId) {
    ...
    ${LabelFragmentDoc}`;
export const TaskByNumberDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    CreateNotificationPreference(variables: CreateNotificationPreferenceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateNotificationPreferenceMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateNotificationPreferenceMutation>({ document: CreateNotificationPreferenceDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateNotificationPreference', 'mutation', variables);
    },
    UpdateNotificationPreference(variables: UpdateNotificationPreferenceMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateNotificationPreferenceMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateNotificationPreferenceMutation>({ document: UpdateNotificationPreferenceDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateNotificationPreference', 'mutation', variables);
    },
    ...
    TaskAttachments(variables: TaskAttachmentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<TaskAttachmentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TaskAttachmentsQuery>({ document: TaskAttachmentsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'TaskAttachments', 'query', variables);
    },
    ...
    TaskByNumber(variables: TaskByNumberQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<TaskByNumberQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TaskByNumberQuery>({ document: TaskByNumberDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'TaskByNumber', 'query', variables);
    },
