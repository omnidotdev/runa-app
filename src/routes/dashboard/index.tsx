          ...
          <div className="py-20 md:py-28 lg:py-36">
            <div className="relative z-10 max-w-3xl">
              ...
              <div className="flex flex-col gap-5 sm:flex-row">
                <Button onClick={handleLogin} className="h-14 w-40">
                  Get Started
                </Button>
            ...
            <div className="relative z-10 mt-32">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4">
                {features.map(({ title, description, icon, color }) => (
                  <div
                    key={title}
                    className={`hover:-translate-y-0.5 rounded-xl border border-gray-200 bg-white p-7 shadow-sm transition-transform hover:shadow-md dark:border-gray-700 dark:bg-gray-800 hover:border-${color}-200 dark:hover:border-${color}-800`}
                  >
                    <div
                      className={`mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-${color}-100 dark:bg-${color}-900/50`}
                    >
                      <svg
              ...
              <div className="mt-4 grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4">
                {features.map(({ title, description, icon, color }) => (
                  <div
                    key={title}
                    className={`hover:-translate-y-0.5 rounded-xl border border-gray-200 bg-white p-7 shadow-sm transition-transform hover:shadow-md dark:border-gray-700 dark:bg-gray-800 hover:border-${color}-200 dark:hover:border-${color}-800`}
