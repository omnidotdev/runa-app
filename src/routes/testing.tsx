...
function Testing() {
  ...
  // TODO: remove. Temporary until `preloadQueries` is available for route loader. See: https://github.com/orgs/TanStack/projects/5?pane=issue&itemId=113403579&issue=TanStack%7Cdb%7C129
        ...
        {tasks.map((task) => (
          ...
          >
            <input
              ...
              onChange={(e) => handleUpdateContent(task.rowId!, e.target.value)}
