...
const features: Feature[] = [
  ...
  },
  {
    ...
    icon: <Workflow className="text-emerald-500" size={24} />,
    color: "emerald",
  },
  {
    ...
    icon: <ChartNoAxesColumnIncreasing className="text-amber-500" size={24} />,
    color: "amber",
  },
];
      ...
      <div className="py-20 md:py-28 lg:py-36">
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex flex-col gap-5 sm:flex-row">
            ...
            {/* <Link
              href="/docs"
              className={cn(buttonVariants({ className: "h-14 w-40" }))}
            >
